            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">Document à valider</h3>
                  {renderDocumentContent()}
                </div>

                {/* Panneau de validation */}
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">Outils de validation finale</h3>
                  <div className="bg-gray-50 p-4 rounded-lg space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-medium">Types d'entités validées</h4>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="font-medium">Annotations reçues pour validation</h4>
                        <Button variant="outline" size="sm" className="text-purple-600 hover:bg-purple-50">
                          <Plus className="w-3 h-3 mr-1" />
                          Modifier annotation
                        </Button>
                      ...
                      {document.metadata.category !== 'Image' && (
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between items-center p-2 bg-white rounded border">
                            ...
                            <div className="flex space-x-2">
                              <Button size="sm" variant="outline" className="text-green-600">✓</Button>
                              <Button size="sm" variant="outline" className="text-red-600">✗</Button>
                            </div>
                          </div>
                          <div className="flex justify-between items-center p-2 bg-white rounded border">
